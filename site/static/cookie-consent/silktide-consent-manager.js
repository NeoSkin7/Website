...
class SilktideCookieBanner {
  ...
  getBannerContent() {
    ...
    const acceptAllButton = `<button class="accept-all st-button st-button--primary btn raise"${acceptAllButtonLabel && acceptAllButtonLabel !== acceptAllButtonText
    ...
    const rejectNonEssentialButton = `<button class="reject-all st-button st-button--primary btn raise"${rejectNonEssentialButtonLabel && rejectNonEssentialButtonLabel !== rejectNonEssentialButtonText
  ...
  getModalContent() {
    ...
    const acceptAllButtonText = this.config.text?.banner?.acceptAllButtonText || 'Accept all';
    const acceptAllButtonLabel = this.config.text?.banner?.acceptAllButtonAccessibleLabel;
    const acceptAllButton = `<button class="preferences-accept-all st-button st-button--primary  btn raise"${acceptAllButtonLabel && acceptAllButtonLabel !== acceptAllButtonText
      ? ` aria-label="${acceptAllButtonLabel}"`
      : ''
      }>${acceptAllButtonText}</button>`;
    ...
    const rejectNonEssentialButtonText = this.config.text?.banner?.rejectNonEssentialButtonText || 'Reject non-essential';
    const rejectNonEssentialButtonLabel = this.config.text?.banner?.rejectNonEssentialButtonAccessibleLabel;
    const rejectNonEssentialButton = `<button class="preferences-reject-all st-button st-button--primary  btn raise"${rejectNonEssentialButtonLabel && rejectNonEssentialButtonLabel !== rejectNonEssentialButtonText
      ? ` aria-label="${rejectNonEssentialButtonLabel}"`
      : ''
      }>${rejectNonEssentialButtonText}</button>`;
    ...
    const modalContent = `
      <header>
        <h2 class="f2 b lh-title">${preferencesTitle}</h2>
        ${closeModalButton}
      </header>
